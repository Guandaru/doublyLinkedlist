...
export class DoublyLinkedList<T> {
    ...
    // one item
    public addToList(data: T): Item<T> {
    ...
    public getNode(index: number): Item<T> {
    ...
    public set(index:number, value: T): Item<T> {
    ...
    public insert(index: number, value: T): Item<T> {
    ...
    public removeNode(index: number): Item<T> {
